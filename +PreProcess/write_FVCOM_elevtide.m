function write_FVCOM_elevtide(Mobj,MJD,casename,MyTitle)
...
%    nodes from Mobj.
%    2014-11-22 (TJU) Updated the Mobj object: the obc_nodes propertity in
%    stored in cell
%   
%==============================================================================
...
ObcNodes = Mobj.obc_nodes{:};
ElevationFile = [casename, '_obc.nc'];
%------------------------------------------------------------------------------
...
% define dimensions
nobc_dimid         = netcdf.defDim(nc,'nobc',nObcs);  % open boundary node number
